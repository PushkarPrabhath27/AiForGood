...
class CaregiverCheckin(BaseModel):
    ...
    raw_response: Mapped[str | None] = mapped_column(String(1000), nullable=True, default=None)
...
class SentinelAlert(BaseModel):
    ...
    hb_at_trigger: Mapped[float | None] = mapped_column(Float, nullable=True, default=None)
    predicted_hb_at_trigger: Mapped[float | None] = mapped_column(Float, nullable=True, default=None)
